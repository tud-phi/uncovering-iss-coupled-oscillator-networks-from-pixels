...
save('../../../datasets/reaction_diffusion/reaction_diffusion.mat','t','x','y','uf','vf','duf','dvf')

%%
% load reaction_diffusion_big
figure;
pcolor(x,y,vf(:,:,1)); shading interp; colormap(hot)
figure;
pcolor(x,y,vf(:,:,end)); shading interp; colormap(hot)
